...
.controller('TakePainDetectCtrl', function($scope, $state, UsersService, PainDetectService){
  ...
  $scope.anteriorColorSwitch = function(body_part_id){
    $scope.pain_detect_result.diagrams.anterior[body_part_id] += 1;
    $scope.pain_detect_result.diagrams.anterior[body_part_id] %= 3;

    var num;
    switch ($scope.pain_detect_result.diagrams.anterior[body_part_id]) {
      case 0:
        num = 0;
        break;
      case 1:
  ...
  $scope.posteriorColorSwitch = function(body_part_id){
    $scope.pain_detect_result.diagrams.posterior[body_part_id] += 1;
    $scope.pain_detect_result.diagrams.posterior[body_part_id] %= 3;

    var num;
    switch ($scope.pain_detect_result.diagrams.posterior[body_part_id]) {
      case 0:
        num = 0;
        break;
      case 1:
